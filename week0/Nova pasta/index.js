...
console.log(`Oi eu sou a ${name}`);

//<div>Titulo: the hunger games. Autor: Suzanne Collins. Nota: 10</div>

//
// ++ => + 1 -> i = i + 1
for (let i = 0; i < books.length; i++) {
  console.log(`Index: ${i}`);
  console.log(`Título: ${books[i].title}`);
  //adicionando uma propriedade ao objeto book
  books[i].estrelas = 5;
